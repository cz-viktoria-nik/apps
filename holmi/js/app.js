var mainView,         // fooldal
    actionView,       // uj kolcsonzes form
    listBorrowView,   // kolcsonvettem lista
    listLendView,     // kolcsonadtam lista
    listArchivesView, // archivalt elemek (visszaadottak)
    newTypeView,     // uj tipus felvitele
    editTypesView,
    editActionView,
    listByTypeView;
